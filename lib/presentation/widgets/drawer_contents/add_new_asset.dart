  ...
  Widget build(BuildContext context) {
    ...
    Widget assetTypeSelector() {
      return DropdownButton<AssetType>(
        value: addNewAssetController.selectedType,
        items: AssetType.values.map((AssetType assetType) {
          return DropdownMenuItem<AssetType>(
            value: assetType,
            child: Text(
              assetType.name,
              style: transactionInfoAssetTypeStyle,
            ),
          );
        }).toList(),
        onChanged: (AssetType? newValue) {
          addNewAssetController.selectedType = newValue!;
        },
      );
    }
